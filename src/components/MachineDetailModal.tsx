...
export const MachineDetailModal: React.FC<MachineDetailModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/30 backdrop-blur-sm p-4">
      <div className="glass-modal rounded-3xl max-w-2xl w-full p-6 shadow-2xl max-h-[90vh] flex flex-col">
        ...
        {/* Tab Navigation */}
        <div className="flex items-center gap-1 border-b border-white/60 py-2 text-xs font-semibold">
          <button
        ...
        <div className="flex-1 overflow-y-auto py-4 space-y-4">
          ...
          {activeTab === 'qr' && (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center text-xs">
              ...
              {/* QR Render Card */}
              <div className="p-4 bg-[#D9EDEE]/60 border border-[#3D848C]/50 rounded-2xl text-center space-y-3">
              ...
              <div className="space-y-3">
                <div className="p-3 bg-white/40 rounded-2xl border border-white/60 space-y-1">
          ...
          {activeTab === 'contadores' && (
            <div className="space-y-4 text-xs">
              ...
              <form onSubmit={handleAddMeterReading} className="p-4 bg-white/40 rounded-2xl border border-white/60 space-y-3">
            ...
            <div className="space-y-3 text-xs">
              ...
              <div className="space-y-2 max-h-60 overflow-y-auto">
                {historyOTs.length === 0 ? (
                  ...
                  historyOTs.map(w => (
                    <div key={w.id} className="p-3 bg-white/40 border border-white/60 rounded-2xl flex items-center justify-between">
                      <div>
                        <div className="flex items-center gap-2">
